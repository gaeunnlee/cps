...
def generate_test_description():
    ...
    process_under_test = ExecuteProcess(
        cmd=[
            '',
            '/home/gaeun/composition_assignment/build/composition/libtalker_component.so',
            '/home/gaeun/composition_assignment/build/composition/liblistener_component.so',
            '',
            ''
        ],
    ...
    def test_dlopen_composition(self, proc_output, process_under_test):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/gaeun/composition_assignment/test/composition_all'
